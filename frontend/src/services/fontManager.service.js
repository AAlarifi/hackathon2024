const toggleFontStyle = () => {
    ...
    // Trigger an event or execute a callback to inform other parts of your application about the font change
    // For simplicity, let's use a custom event
    document.dispatchEvent(new CustomEvent('fontToggled', { detail: isArialEnabled ? 'Arial' : 'SansSerif' }));
};
